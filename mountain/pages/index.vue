...
console.log("這是", mountainsData.mountainsData)

// console.log("這是", mountainsData[0].name)
...
<template>
  ...
  <section class="main">
    ...
    <div class="main-content">
      <!-- <MountainCard v-for="mountain in parentMessage" :key="mountain.id" :message="mountain" /> -->
